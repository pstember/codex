...
- Custom Manager questions are disabled outside App Server mode and still run only through the fixed GraphQL schema; generated GraphQL is parsed and validated before execution against the in-memory seeded catalog.
